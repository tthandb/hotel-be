...
const ReservationRoom = {
  ...
  insertSome: (id, data, callback) => {
    const query =
      "INSERT INTO res_rooms (reservation_id, room_type_id, check_in_date, check_out_date, adults, rate, comments) VALUES (?,?,?,?,?,?,?);"
